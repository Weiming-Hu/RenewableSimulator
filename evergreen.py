...
if __name__ == '__main__':
    ...
    welcome_msg = "evergreen -- our pursuit of a more sustainable future\n" + \
        ...
        "Specify an input weather analog file from the command line,\n" +\
        "Edit the source file 'evergreen.py' if you want to change the variable mapping and simulation scenarios."
